...
docker exec 806c6d246fe9 npx prisma generate --schema=./prisma/schema-consumer.prisma
docker exec 806c6d246fe9 npx prisma db push --force-reset --schema=./prisma/schema-consumer.prisma
