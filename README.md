...
docker exec f9640dfdf4cc npx prisma generate --schema=./prisma/schema-consumer.prisma
docker exec f9640dfdf4cc npx prisma db push --force-reset --schema=./prisma/schema-consumer.prisma
