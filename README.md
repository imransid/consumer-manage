...
docker exec 16a91ec9e3c2 npx prisma generate --schema=./prisma/schema-consumer.prisma
docker exec 16a91ec9e3c2 npx prisma db push --force-reset --schema=./prisma/schema-consumer.prisma
