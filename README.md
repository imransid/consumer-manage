...
docker exec aa9b052fc8e7 npx prisma generate --schema=./prisma/schema-consumer.prisma
docker exec aa9b052fc8e7 npx prisma db push --force-reset --schema=./prisma/schema-consumer.prisma
