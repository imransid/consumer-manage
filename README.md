# balanzify-consumer-payroll - Intelligent Testing Platform
...
docker exec 2d30ebd74fdc npx prisma generate --schema=./prisma/schema-consumer.prisma
docker exec 2d30ebd74fdc npx prisma db push --force-reset --schema=./prisma/schema-consumer.prisma
