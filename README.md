...
docker exec 3137c0803b94 npx prisma generate --schema=./prisma/schema-consumer.prisma
docker exec 3137c0803b94 npx prisma db push --force-reset --schema=./prisma/schema-consumer.prisma
